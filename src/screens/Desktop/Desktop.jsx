      ...
      <div className="div">
        <div className="overlap">
          ...
          <div className="what-section">
                ...
                <div className="frame">
                  <div className="group-2">
                    ...
                    <p className="text-wrapper">
                      Focus on effectuators - entrepreneurs who believe that opportunities are made by yourself, not
                      found
                    </p>
                  </div>
                  <div className="group-3">
                    ...
                    <div className="img-wrapper">
                      <img className="img" alt="Group" src="/img/group-9286.png" />
                    </div>
                  </div>
                  <div className="group-4">
                    <p className="p">U-centered empathic approach with in-depth interviews</p>
            ...
            <p className="h">are empathic in-depth interviews with&nbsp;&nbsp;entrepreneurs</p>
          </div>
        </div>
        <div className="footer-frame">
          ...
          <div className="footer-menu">
            <div className="frame-2">
              ...
              <div className="text-wrapper-4">Podcast</div>
              <div className="text-wrapper-5">Categories</div>
              <div className="text-wrapper-4">Contact</div>
            </div>
          </div>
          <img className="footer-line" alt="Footer line" src="/img/footer-line.png" />
          <div className="logo">
            <div className="div-wrapper">
              <div className="group-8">
                <div className="overlap-group-2">
                  <img className="vector-3" alt="Vector" src="/img/vector-11.png" />
                  <img className="vector-4" alt="Vector" src="/img/vector-10.png" />
                  <div className="overlap-3">
                    <img className="vector-5" alt="Vector" src="/img/vector-5.png" />
                    <img className="vector-6" alt="Vector" src="/img/vector-8.png" />
                    <img className="vector-7" alt="Vector" src="/img/vector-7.png" />
                    <img className="vector-8" alt="Vector" src="/img/vector-6.png" />
                    <img className="vector-5" alt="Vector" src="/img/vector-5.png" />
                    <img className="vector-9" alt="Vector" src="/img/vector-4.png" />
                    <img className="vector-10" alt="Vector" src="/img/vector-3.png" />
                    <img className="vector-11" alt="Vector" src="/img/vector-2.png" />
                    <img className="vector-12" alt="Vector" src="/img/vector-1.png" />
                  </div>
                </div>
              ...
              <div className="overlap-5">
                ...
                <button className="submit-button">
                  <div className="tagline-wrapper">
                    <div className="h-tagline">Subscribe</div>
                  </div>
                </button>
                ...
                <div className="radio-group">
                  <div className="col">
                    <div className="radio-input">
                      <div className="text-wrapper-7">Entrepreneurs effectuators</div>
                      <div className="ellipse-7" />
                    </div>
                    <div className="radio-input-2">
                      <div className="text-wrapper-7">Entrepreneurship researchers</div>
                      <div className="div-2">
        ...
        <div className="reviews-section">
          ...
          <div className="overlap-7">
            ...
            <div className="testimonial-contetnt">
              <img className="testimonial-photo" alt="Testimonial photo" src="/img/testimonial-photo.png" />
              <div className="testimonial-details">
                <div className="testimonial-name">
                  <div className="text-wrapper-9">Irene Buller</div>
                </div>
                <div className="testimonial-position">
                  <div className="text-wrapper-10">Senior Consultant, EY, Switzerland</div>
                </div>
                <div className="testimonial-text">
                  <p className="text-wrapper-11">
                    I’ve seen so many interviews with entrepreneurs, including on educational platforms, but this is the
                    first time I’ve seen this exact effectuation approach. I work in a research environment and I see
                    that the use of research findings in interviews adds a special character and makes them truly
        ...
        <div className="values-section">
          <div className="values-list">
            <div className="item">
              <div className="text-wrapper-12">Educating with entrepreneurs interviews</div>
              <div className="text-wrapper-13">High-quality</div>
              <img className="item-icon" alt="Item icon" src="/img/item-icon-1.png" />
            </div>
            <div className="item">
              <p className="text-wrapper-12">Creating a future by taking action</p>
              <div className="text-wrapper-14">Effectuation</div>
              <img className="item-icon" alt="Item icon" src="/img/item-icon.png" />
            </div>
            <div className="item">
              <p className="text-wrapper-12">Engaging learning for personal growth</p>
            ...
            <div className="item-2">
              <p className="text-wrapper-16">Sharing achievements between business researchers and entrepreneurs</p>
          ...
          <button className="button">
            <div className="frame-3">
              <div className="tagline-6">Get Started</div>
            </div>
          </button>
          <div className="h-3">
        ...
        <div className="podcast">
            ...
            <div className="podcast-list">
              <div className="podcast-item">
                <div className="overlap-group-6">
                  <div className="text-wrapper-18">Watch engaging video interviews</div>
                </div>
              </div>
              <div className="podcast-item">
                <div className="overlap-10">
                  <p className="text-wrapper-19">Study written transcripts of in-depth interviews</p>
                </div>
              </div>
              <div className="podcast-item">
                <div className="listen-to-the-wrapper">
                  <p className="listen-to-the">
                    Listen to the podcasts with entrepreneurship researchers <br />( get your mini-PhD :)
                  </p>
                </div>
              </div>
            </div>
          ...
          <img className="podcast-image" alt="Podcast image" src="/img/podcast-image.png" />
          <p className="podcast-description">
            Every day thousands of business research interviews shape the science of entrepreneurship
          </p>
          <div className="tag-4">
          ...
          <p className="h-4">Enjoy in-depth U-interviews by joining the open research on entrepreneurs psychology</p>
        </div>
        <div className="value-for-u-section">
          ...
          <button className="button-2">
            <div className="overlap-12">
              <div className="tagline-11">View All Categories</div>
            </div>
          </button>
            ...
            <div className="values-for-all">
              ...
              <div className="value-item-2">
                <div className="overlap-group-7">
                  ...
                  <p className="text-wrapper-21">
                    U-interviews with entrepreneurship researchers for business insights
                  </p>
                  <div className="text-wrapper-22">#Popular</div>
                </div>
              </div>
        ...
        <div className="starting-section">
          <div className="overlap-14">
            ...
            <p className="h-8">Empathy-based learning of how to spend your lifetime doing business you enjoy</p>
            <div className="h-9">of the world</div>
            <button className="button-3">
              <div className="overlap-group-8">
                <div className="tagline-12">Get Started</div>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="image-wrapper">
          <div className="div-wrapper">
            <div className="group-8">
              <img className="logo-image" alt="Logo image" src="/img/logo-image.png" />
              <div className="text-wrapper-6">U-Universe</div>
            </div>
          </div>
        </div>
